...
public class Sales extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TodaySales.setBackground(new java.awt.Color(204, 204, 204));
        TodaySales.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        ...
        TodaySales.setFillsViewportHeight(true);
        TodaySales.setRowHeight(25);
        Sales.setViewportView(TodaySales);
        if (TodaySales.getColumnModel().getColumnCount() > 0) {
            TodaySales.getColumnModel().getColumn(2).setResizable(false);
        }

        jPanel1.add(Sales, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 70, 910, 370));
        ...
        jPanel1.add(Print, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 490, 150, 50));
    ...
    private void loadInvoiceDetails(){
        ...
        pos.setInvoiceDate(currentDate);
        
        try{
            ResultSet rs = pos.getTodaySalesInvoice();
            TodaySales.setModel(DbUtils.resultSetToTableModel(rs));
        }
    ...
    private void searchinvoicetxtKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchinvoicetxtKeyReleased
        ...
        try{
            ResultSet rs = pos.searchTodayInvoice();
            TodaySales.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void PrintMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PrintMouseClicked
        ...
        int i = TodaySales.getSelectedRow();
        if (i == -1) {
            ...
            String ID = TodaySales.getValueAt(i, 0).toString();
