...
public class UpdateSuppliers extends javax.swing.JDialog {
     ...
     */
    public UpdateSuppliers(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
     ...
     public UpdateSuppliers(java.awt.Frame parent, boolean modal,String Supplier_ID) {
        super(parent, modal);
        initComponents();
        saveout = new ImageIcon(getClass().getResource("/view/Inventory/saveOut.png"));
        saveenter = new ImageIcon(getClass().getResource("/view/Inventory/saveEnter.png"));
    ...
    private void loadSupplierDetails(){
        ...
        hs.setSupplierID(this.supID);
        try{
            ResultSet rs = hs.getSelectedSupplierDetails();
            if(rs.next()){
                supplieridtxt.setText(rs.getString(1));
                fnametxt.setText(rs.getString(2));
                lnametxt.setText(rs.getString(3));
                companynametxt.setText(rs.getString(4));
                cnumtxt.setText(rs.getString(5));
             ...
             JOptionPane.showMessageDialog(null, "Database cannot be found.", "Error", JOptionPane.ERROR_MESSAGE);
        } 
    ...
    private void initComponents() {
        ...
        title.setText("Update Supplier Details");
    ...
    private void savebtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_savebtnMouseClicked
        ...
        if(fnametxt.getText().equalsIgnoreCase("") || lnametxt.getText().equalsIgnoreCase("")
            ...
            JOptionPane.showMessageDialog(null,"All fields are required.", "WARNING",JOptionPane.WARNING_MESSAGE);
              ...
              if(valid.validateSupplierID(supplieridtxt.getText()) && valid.validateName(fnametxt.getText()) && valid.validateName(lnametxt.getText())&& valid.validateContactNum(cnumtxt.getText())){
                ...
                hs.setSupplierID(this.supID);                   
                hs.setUpdateSupplierID(supplieridtxt.getText().trim());                
                ...
                try{
                    int i = hs.updateSupplier();
                    if(i!=0){
              
                    JOptionPane.showMessageDialog(null, "Supplier has been Updated successfully.", "Message", JOptionPane.INFORMATION_MESSAGE);
                    this.dispose();
                    }else{
                      JOptionPane.showMessageDialog(null, "Supplier cannot be update.", "Error", JOptionPane.ERROR_MESSAGE);
                      this.dispose();
                    }
                }                         
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateSuppliers dialog = new UpdateSuppliers(new javax.swing.JFrame(), true);
