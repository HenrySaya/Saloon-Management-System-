...
CREATE DATABASE IF NOT EXISTS salondatabase DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE salondatabase ;
...
SELECT * FROM Appointment_has_service;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS PurchaceInvoice (
  ...
  INDEX fk_PurchaceInvoice_Stock1_id (Stock_Stock_ID ASC),
  CONSTRAINT fk_PurchaceInvoice_Stock1
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB;
SELECT * FROM PurchaceInvoice;
SELECT * FROM Invoice_has_Stock;
...
SELECT * FROM Invoice_has_service;
...
CREATE TABLE IF NOT EXISTS `salondatabase`.`Invoice_has_Stock` (
  ...
  CONSTRAINT `fk_Invoice_has_Stock_Stock1`
    ...
    ON UPDATE CASCADE)
ENGINE = InnoDB;
SELECT * FROM Invoice_has_Appointment;
SELECT * FROM Appointment_has_Employee;
